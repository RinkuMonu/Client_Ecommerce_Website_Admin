...
//       label: 'categories',
//       children: [
//         { key: '10', label: <Link to="/categories">categories</Link> },
//       ],
//     },
//     {
//       key: 'sub72',
...
function Sidebar() {
  ...
  const commonMenuItems = [
    ...
    },
    {
      ...
      label: 'Categories',
      children: [
        { key: 'categories-list', label: <Link to="/categories">Categories</Link> },
      ],
    },
    {
      key: 'banners',
    ...
    },
    {
      ...
      label: 'Orders',
      children: [
        { key: 'received-orders', label: <Link to="/orders">Received Orders</Link> },
      ],
    },
    {
      key: 'settings',
      ...
      label: 'Settings',
      children: [
        { key: 'my-profile', label: <Link to="/settings/profile">My Profile</Link> },
      ],
    },
    {
      key: 'users',
  ...
  const adminMenuItems = [
    {
      ...
      label: 'Websites',
      children: [
        { key: 'all-websites', label: <Link to="/websites">All Websites</Link> },
      ],
    },
    {
      key: 'all-categories',
      ...
      children: [
        { key: 'category-management', label: <Link to="/categories">All Categories</Link> },
      ],
    },
  ];
    ...
    user?.role === 'super-admin'
      ...
      ? [
          ...commonMenuItems,
          {
            ...
            label: 'Vendor Requests',
            children: [
              { key: 'vendors-list', label: <Link to="/vendors">Vendors list</Link> },
            ],
          },
        ]
      : [];
